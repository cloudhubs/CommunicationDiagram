...
public class CDBuilderTester {
    ...
    @ValueSource(strings = {
            ...
            "DEFINE_TYPES foo BEGIN_PROGRAM CALL_FUNCTION END_PROGRAM",
            "DEFINE_TYPES foo BEGIN_PROGRAM CALL_FUNCTION END_FUNCTION_CALL END_PROGRAM",
            "DEFINE_TYPES foo BEGIN_PROGRAM DECLARE foo bar CALL_FUNCTION bar END_FUNCTION_CALL END_PROGRAM",
            "DEFINE_TYPES foo BEGIN_PROGRAM DECLARE foo bar CALL_FUNCTION bar method END_FUNCTION_CALL END_PROGRAM",
            "DEFINE_TYPES foo foo2 DEFINE_FUNCTION foo2 method END_DEFINE_FUNCTION BEGIN_PROGRAM DECLARE foo bar CALL_FUNCTION bar method END_FUNCTION_CALL END_PROGRAM",
            "DEFINE_TYPES foo DEFINE_FUNCTION foo method END_DEFINE_FUNCTION BEGIN_PROGRAM DECLARE foo bar CALL_FUNCTION bar method END_PROGRAM",
            "DEFINE_TYPES foo DEFINE_FUNCTION foo method END_DEFINE_FUNCTION BEGIN_PROGRAM DECLARE foo bar BEGIN_IF CALL_FUNCTION bar method END_IF END_PROGRAM",
            "DEFINE_TYPES foo DEFINE_FUNCTION foo method END_DEFINE_FUNCTION BEGIN_PROGRAM DECLARE foo bar BEGIN_IF X==2 CALL_FUNCTION bar method BEGIN_ELSE END_ELSE END_IF END_PROGRAM"
    })
